 ...
 */
export type NodeKind = 'function' | 'method' | 'class' | 'interface' | 'struct' | 'module' | 'constant' | 'table' | 'endpoint';
export type EdgeType = 'calls' | 'imports' | 'inherits' | 'implements' | 'references' | 'defines' | 'queries';
/**
